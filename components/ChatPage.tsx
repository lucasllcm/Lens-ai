...
type MaterialIconName = 'flash-on' | 'auto-awesome';
        ...
        options={{
          headerTitle: () => (
            <HeaderDropDown
              title="ChatGPT"
              items={[
                { key: '3.5', title: 'GPT-3.5', icon: 'flash-on' as MaterialIconName },
                { key: '4', title: 'GPT-4', icon: 'auto-awesome' as MaterialIconName },
              ]}
